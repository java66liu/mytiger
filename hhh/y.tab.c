...
static const char *const yytname[] =
{
  ...
  "VAR", "TYPE", "$accept", "program", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 44 "tiger.y" /* yacc.c:1646  */
    {printf("LET TYPE |%s|%lu| = type IN END\n", (yyvsp[-4].sval), strlen((yyvsp[-4].sval)));}
